...
public class Coke_Store_Locator_Page extends Basepage {
	
	public  Coke_Store_Locator_Page(WebDriver driver) { 
		super(driver);
	}	
	@FindBy(xpath="//html/body/main/div/div/div/div/div/div/div/form/div[2]/button/span[2]")  
	WebElement locatemelabel;
	@FindBy(xpath="//*[@id='maincontent']/div[1]/div/div/div/div[1]/div/div/form/div[1]/div[1]/div/label")  
	...
	@FindBy(xpath="//html/body/main/div/div/div/div/div[2]/div/div/div/div[2]/div/div/div/div/span[2]")  
	WebElement addressmappincount1;
	@FindBy(xpath="//html/body/main/div/div/div/div/div[2]/div/div/div/div[2]/div/div/div[7]/div/span[2]")  
	...
	@FindBy(xpath="//*[@id='maincontent']/div[1]/div/div/div/div[1]/div/div/form/div[3]/div[1]/div[2]/div[2]/button/span[2]")  
	...
	@FindBy(xpath="//*[@id='maincontent']/div[1]/div/div/div/div[1]/div/div/form/div[3]/div[1]/div[2]/div[1]/div[1]/button/span")  
	WebElement listviewlabel;
	@FindBy(xpath="//*[@id='rl-list-1']/div[2]/div[1]/span[2]")  
	WebElement roolmappin2;
	@FindBy(xpath="//*[@id='maincontent']/div[1]/div/div/div/div[1]/div/div/form/div[3]/div[1]/div[2]/div[1]/div[2]/button/span[2]")  
	WebElement mapviewlabel;
	@FindBy(xpath="//*[@id='maincontent']/div[1]/div/div/div/div[2]/div[1]/div[1]/div/div[1]/div/button")  
	WebElement loadmorelabel;
	@FindBy(xpath="//*[@id='rl-list-5']/div[2]/div[1]/span[2]")  
	WebElement rlmappin6;
	@FindBy(xpath="//html/body/main/div/div/div/div/div[2]/div/div/div/div/ul/li[2]/div[2]/div[2]/div/div/div[3]/a")  
	WebElement listviewgetdirectionlabel;
	@FindBy(xpath="//html/body/div[1]/div[1]/div/button")  
	WebElement cancelbuttonblackcookes;
	...
	public void cancelbuttonblackcookesmethod() { 
		try {
		 this.click(cancelbuttonblackcookes);
		}catch (Exception e) {
	...
	public String ubereatmethods1p() throws Exception { 
		this.waitForElementToBeVisible1(continuebutton);
		this.click(continuebutton);
		this.windowhandles();
		return this.getPageTitle();
	...
	public String selectaddressonmapmethod() throws Exception {
		this.waitForElementToBeVisible1(clickonmapaddress7);
	...
	public String searchbuttonmethod2(String sendval) throws Exception  { 
		driver.navigate().refresh();
		Thread.sleep(4000);
		try {
			 this.click(cancelbuttonblackcookes);
