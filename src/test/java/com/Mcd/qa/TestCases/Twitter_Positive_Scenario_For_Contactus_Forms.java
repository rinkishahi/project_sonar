...
public class Twitter_Positive_Scenario_For_Contactus_Forms extends BaseTest {
	
	
	@Test(priority = 1)
	public void Twitter_Restaurant_Feedback_Positive_scenario() throws IOException {
		...
		try {
			driver.get(Basepage.readProperty("urlRT"));
...
//Restaurant locator		
	...
	@Test(priority = 2)
	public void Twitter_General_Enquire_Positive_scenario() throws Exception {
		...
		TestUtil Excelreader = new TestUtil(excelptha + "/src/main/java/com/McD/qa/TestData/Core_General_Inquiry.xlsx");		
			try {
				driver.get(Basepage.readProperty("urlGT"));
	...
	@Test(priority = 3)
	public void Twitter_Mobile_App_Feedback_Positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlBT"));
			String gettitle = page.generallgetpagetitlemethod();
	...
	@Test(priority = 4)
	public void Twitter_Franchising_Positive_Scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlFT"));
			String gettitle = page.generallgetpagetitlemethod();
			String gettitleexcel = Excelreader.getData(0, 1, 5);
			if (gettitle.equals(gettitleexcel)) {
	...
	@Test(priority = 5)
	public void Twitter_Trademark_Permission_Positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlTT"));
	...
	@Test(priority = 6)
	public void Twitter_CCPA_Mcdonald_May_positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlccpaT"));
			String gettitle = page.generallgetpagetitlemethod();
			String gettitleexcel = Excelreader.getData(0, 1, 5);
			if (gettitle.equals(gettitleexcel)) {
	...
	@Test(priority = 7)
	public void Twitter_old_Restaurant_Feedback_Form_Positive_scenario() throws IOException {
	...
	try {
	driver.get(Basepage.readProperty("urlORT"));
