...
public class Positive_Scenarios_All_Forms extends BaseTest {
	
	
	@Test(priority = 1)
	public void Restaurant_Feedback_Positive_scenario() throws IOException {
...
//Restaurant locator		
		...
		// CLICK yes radio button
				...
				try {
					String statedropdownvaluehead = page.stateselecteddropdownvalmethod2();
					String staelabelexcel = Excelreader.getData(0, 78, 7);
	...
	@Test(priority = 2)
	public void General_Enquire_Positive_scenario() throws Exception {
		...
		TestUtil Excelreader = new TestUtil(excelptha + "/src/main/java/com/McD/qa/TestData/Core_General_Inquiry.xlsx");		
			...
			try {
						...
						String statedropdownvalueexcel = Excelreader.getData(0, 54, 3);
	...
	@Test(priority = 3)
	public void Mobile_App_Feedback_Positive_scenario() {
		...
		try {
			...
			String statecontfindselectedvalexcel1 = Excelreader.getData(0, 59, 6);
	...
	@Test(priority = 4)
	public void Franchising_Positive_Scenario() {
	...
	@Test(priority = 5)
	public void Trademark_Permission_Positive_scenario() {
		...
		try {
				...
				String statedropdownvalueEXCEL = Excelreader.getData(0, 106, 6);
				if (statedropdownvaluehead.equals(statedropdownvalueEXCEL)) {
	...
	@Test(priority = 6)
	public void CCPA_Mcdonald_May_positive_scenario() {
		...
		try {
			...
			String statedropdownvalueexcel = Excelreader.getData(0, 29, 6);
			if (statedropdownvaluehead.equals(statedropdownvalueexcel)) {
	...
	/*@Test(priority = 7)
	public void old_Restaurant_Feedback_Form_Positive_scenario() throws IOException {
	...
	//Restaurant locator		
			...
			String restaurantaddspchanumahead = page.resraurantaddvaluemethod2(restaurantaddspchanumarexcel);
			if (restaurantaddspchanumahead.equals(restaurantaddspchanumarexcel)) {
			...
			try {
			String statecontfindselectedvalhead = page.statecontfindsendedvaluemethod1();
