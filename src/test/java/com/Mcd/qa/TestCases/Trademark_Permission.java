...
public class Trademark_Permission extends BaseTest {

	String excelptha = System.getProperty("user.dir");
	TestUtil Excelreader = new TestUtil(excelptha + "/src/main/java/com/McD/qa/TestData/Trademark_permission.xls");

	@Test(priority = 1)
	public void Open_URLT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
	...
	@Test(priority = 2)
	public void Trademark_Permission_label() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Trademark_Permission_label");
	...
	@Test(priority = 3)
	public void Pick_Different_TopicT() throws IOException {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		...
		try {
			...
			try {
				...
				if (mobilefeeddropdownlabelhead.equals(mobilefeeddropdownlabelexcel)) {
					test.pass("TC: THE DROPDWON 'PICK A DIFFERENT TOPIC' SHOULD BE CLICKABLE");
					String mobilefeeddropdownlabelhea1 = page.mobilefeedgetAtrributeValuemethod();
					String mobilefeeddropdownlabelexcel1 = Excelreader.getData(0, 9, 5);
					if (mobilefeeddropdownlabelhea1.equals(mobilefeeddropdownlabelexcel1)) {
						test.pass("TC: USER SHOULD BE SELECT 'MOBILE APP FEEDBACK' OPTION");
						String gettitle = page.generallgetpagetitlemethod1();
	...
	@Test(priority = 4)
	public void How_Can_We_Help_youT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("How_Can_We_Help_youT");
		// how can we help you
		try {
	...
	@Test(priority = 5)
	public void Reason_For_You_RequestT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Reason_For_You_RequestT");
		...
		try {
			...
			if (pleaseselectdropdownvaluehead.equals(pleaseselectdropdownvalueexcel)) {
				...
				String pleaseselectdropdownvaluehead1 = page.pleaseselectdropdownvalueattributemethod();
				String pleaseselectdropdownvalueexcel1 = Excelreader.getData(0, 19, 5);
				if (pleaseselectdropdownvaluehead1.equals(pleaseselectdropdownvalueexcel1)) {
					test.pass("TC:15 USER ABLE TO SELECT DROP DOWN VALUE IN PLEASE SELECT ANY ONE OPTION FUNCTION");
				} else {
					test.fail("TC:15 USER NOT ABLE TO SELECT DROP DOWN VALUE IN PLEASE SELECT ANY ONE OPTION FUNCTION");
					test.fail(test.addScreenCaptureFromPath(Extentreport.getScreenshot(driver, "Trademark_Permission"))
							+ "USER NOT ABLE TO SELECT DROP DOWN VALUE IN PLEASE SELECT ANY ONE OPTION FUNCTION");
				}
			} else {
	...
	@Test(priority = 6)
	public void Tell_Us_About_Your_RequestT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
	...
	public void When_Was_the_Request_Submitted() {
		...
		try {
			...
			if (visitdatemothsendvalue1head.equals(visitdatemothsendvalexcel1)) {
				...
				String visitdatemothsendvalhead = page.whenwasmonthlabelmethod3();
				String visitdatemothsendvalexcel = Excelreader.getData(0, 44, 5);
				if (visitdatemothsendvalhead.equals(visitdatemothsendvalexcel)) {
					...
					test.fail(test.addScreenCaptureFromPath(Extentreport.getScreenshot(driver, "Trademark_Permission"))
							+ "23 USER SHOULD BE SELECT DROP DOWN VALUE IN MONT FUNTION");
				}
			} else {
	...
	public void Supporting_Attachments() {
		...
		/*// upload file error msg
				try {
					String fileonelabelhead = page.fileoneerrormethod();
					String fileonelabelexcel = Excelreader.getData(0, 168, 5);
					if (fileonelabelhead.equals(fileonelabelexcel)) {
						test.pass("TC:33 VERIFY LABEL 'FILE 1' IS DISPLAYYED");
					} else {
						test.fail("TC:33 VERIFY LABEL 'FILE 1' IS NOT DISPLAYYED");
	...
	@Test(priority = 17)
	public void First_NameT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("First_NameT");
		...
		try {
			...
			String finamerrorexcel2 = Excelreader.getData(0, 82, 5);
	...
	@Test(priority = 18)
	public void Last_NameT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Last_NameT");
	...
	@Test(priority = 19)
	public void Address_UsonlyT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Address_UsonlyT");
	...
	@Test(priority = 20)
	public void Apt_SuiteT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Apt_SuiteT");
		// LABEL OF APT/SUITE
		try {
	...
	public void ConfirmT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("ConfirmT");
	...
	@Test(priority = 26)
	public void Phone_NumberT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("Phone_NumberT");
	...
	@Test(priority = 27)
	public void By_Selecting_SubmitT() {
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		test = extent.createTest("By_Selecting_SubmitT");
...
/*
	@Test(priority = 30)
	public void Header_CareersTMP() {
		test = extent.createTest("Header_CareersTMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		try {
			driver.get(Basepage.readProperty("urlT"));
		...
		try {
			...
			String headercareerslabelexcel = Excelreader.getData(0, 153, 5);
		...
		try {
			...
			String headercareersclickexcel = Excelreader.getData(0, 154, 5);
			if (headercareersclickhead.equals(headercareersclickexcel)) {
				...
				String leavingcancelbuttonexcel = Excelreader.getData(0, 154, 5);
		...
		try {
			...
			String headercareersclickexcel = Excelreader.getData(0, 155, 5);
			if (headercareersclickhead.equals(headercareersclickexcel)) {
	...
	@Test(priority = 31)
	public void Footer_CareerstTMP() {
		test = extent.createTest("Footer_CareerstTMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		try {
			driver.get(Basepage.readProperty("urlT"));
		...
		try {
			...
			String Footercareerslabelexcel = Excelreader.getData(0, 153, 5);
		...
		try {
			...
			String Footercareersclickexcel = Excelreader.getData(0, 154, 5);
			if (Footercareersclickhead.equals(Footercareersclickexcel)) {
				...
				String leavingcancelbuttonfooterexcel = Excelreader.getData(0, 154, 5);
		...
		try {
			...
			String footercareersclickexcel1 = Excelreader.getData(0, 155, 5);
	...
	@Test(priority = 32)
	public void Footer_Education_Opportunities_TMP() {
		test = extent.createTest("Footer_Education_Opportunities_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		try {
			driver.get(Basepage.readProperty("urlT"));
		...
		try {
			...
			String Footereducationlabelexcel = Excelreader.getData(0, 156, 5);
		...
		try {
			...
			String Footereducationclickexcel = Excelreader.getData(0, 154, 5);
		...
		try {
			...
			String footereducationopporclickexcel = Excelreader.getData(0, 157, 5);
	...
	@Test(priority = 33)
	public void Footer_Employee_Perks_TMP() {
		test = extent.createTest("Footer_Employee_Perks_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		try {
			driver.get(Basepage.readProperty("urlT"));
		...
		try {
			...
			String Footeremployeelabelexcel = Excelreader.getData(0, 158, 5);
		...
		try {
			...
			String footeremployeeclickexcel1 = Excelreader.getData(0, 159, 5);
	...
	@Test(priority = 34)
	public void Footer_MEET_Our_People_TMP() {
		test = extent.createTest("Footer_MEET_Our_People_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		...
		try {
			...
			String Footeremeetourpeoplelabeexcel = Excelreader.getData(0, 160, 5);
		...
		try {
			...
			String Footermeetourpeopleclickexcel = Excelreader.getData(0, 154, 5);
			if (Footermeetourpeopleclickhead.equals(Footermeetourpeopleclickexcel)) {
				...
				String leavingcancelbuttonmeetourpeopleexcel = Excelreader.getData(0, 154, 5);
		...
		try {
			...
			String footermeetourpeopleclickexcel1 = Excelreader.getData(0, 161, 5);
	...
	@Test(priority = 35)
	public void Footer_For_Our_Veterans_TMP() {
		test = extent.createTest("Footer_For_Our_Veterans_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		try {
			driver.get(Basepage.readProperty("urlT"));
		...
		try {
			...
			String Footeremeetourpeoplelabeexcel = Excelreader.getData(0, 162, 5);
			if (Footeremeetourpeoplelabelhead.equals(Footeremeetourpeoplelabeexcel)) {
		...
		try {
			...
			String footermeetourpeopleclickexcel1 = Excelreader.getData(0, 163, 5);
			if (footeremeetourpeopleclickhead1.equals(footermeetourpeopleclickexcel1)) {
	...
	@Test(priority = 36)
	public void Footer_Working_With_Us_TMP() {
		test = extent.createTest("Footer_Working_With_Us_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		...
		try {
			...
			String Footeremeetourpeoplelabeexcel = Excelreader.getData(0, 164, 5);
			if (Footeremeetourpeoplelabelhead.equals(Footeremeetourpeoplelabeexcel)) {
		...
		try {
			...
			String footermeetourpeopleclickexcel1 = Excelreader.getData(0, 165, 5);
			if (footeremeetourpeopleclickhead1.equals(footermeetourpeopleclickexcel1)) {
	...
	@Test(priority = 37)
	public void Footer_Apply_Now_TMP() {
		test = extent.createTest("Footer_Apply_Now_TMP");
		Trademark_permission_Page page = new Trademark_permission_Page(driver);
		...
		try {
			...
			String Footeremeetourpeoplelabeexcel = Excelreader.getData(0, 166, 5);
			if (Footeremeetourpeoplelabelhead.equals(Footeremeetourpeoplelabeexcel)) {
		...
		try {
			...
			String footermeetourpeopleclickexcel1 = Excelreader.getData(0, 167, 5);
			if (footeremeetourpeopleclickhead1.equals(footermeetourpeopleclickexcel1)) {
