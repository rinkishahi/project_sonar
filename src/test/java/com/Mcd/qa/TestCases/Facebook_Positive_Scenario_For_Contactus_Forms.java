...
public class Facebook_Positive_Scenario_For_Contactus_Forms extends BaseTest {
	
	
	@Test(priority = 1)
	public void FB_Restaurant_Feedback_Positive_scenario() throws IOException {
		...
		try {
			driver.get(Basepage.readProperty("urlRF"));
...
//Restaurant locator		
	...
	@Test(priority = 2)
	public void FB_General_Enquire_Positive_scenario() throws Exception {
		...
		TestUtil Excelreader = new TestUtil(excelptha + "/src/main/java/com/McD/qa/TestData/Core_General_Inquiry.xlsx");		
			try {
				driver.get(Basepage.readProperty("urlGF"));
	...
	@Test(priority = 3)
	public void FB_Mobile_App_Feedback_Positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlBF"));
			String gettitle = page.generallgetpagetitlemethod();
	...
	@Test(priority = 4)
	public void FB_Franchising_Positive_Scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlFF"));
			String gettitle = page.generallgetpagetitlemethod();
			String gettitleexcel = Excelreader.getData(0, 1, 5);
			if (gettitle.equals(gettitleexcel)) {
	...
	@Test(priority = 5)
	public void FB_Trademark_Permission_Positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlTF"));
	...
	@Test(priority = 6)
	public void FB_CCPA_Mcdonald_May_positive_scenario() {
		...
		try {
			driver.get(Basepage.readProperty("urlccpaF"));
			String gettitle = page.generallgetpagetitlemethod();
			String gettitleexcel = Excelreader.getData(0, 1, 5);
			if (gettitle.equals(gettitleexcel)) {
	...
	@Test(priority = 7)
	public void FB_old_Restaurant_Feedback_Form_Positive_scenario() throws IOException {
	...
	try {
	driver.get(Basepage.readProperty("urlORF"));
